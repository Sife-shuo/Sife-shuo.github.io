...
function playy(){//00:00:00
  var timee=document.getElementById('needing').value.split(':');
  ...
  num=(Number(timee[0])*3600+Number(timee[1])*60+Number(timee[2]))/5;
  document.getElementById('video-wrapper').innerHTML='';
  playerwin(SifeArray[num]);
}
function next(){num+=1;playerwin(SifeArray[num])}
